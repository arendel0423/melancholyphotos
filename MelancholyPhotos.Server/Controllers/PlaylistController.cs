...
namespace MelancholyPhotos.Server.Controllers
{
    ...
    public class PlaylistController : ControllerBase
    {
        ...
        {
            var playlistPath = System.IO.Path.Combine(_env.WebRootPath, "gallery-playlist");
            ...
            var tracks = audioExtensions
                ...
                .Select((filePath, index) =>
                {
                    ...
                    // Read ID3/metadata tags from the audio file
                    try
                    {
                    ...
                    // Optional sidecar .txt overrides: line 1 = title, line 2 = artist, line 3 = album
                    ...
                    var src = $"/gallery-playlist/{Uri.EscapeDataString(System.IO.Path.GetFileName(filePath))}";
